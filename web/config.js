...
const CONFIG = {
  ...
  markers: [
    ...
    { id:"m-cctv", label:"CCTV", source:"cctv",
      parts:[ {r:0.9, z:0,    h:44,  c:[110,110,130]},   // 지주(길게)
              {r:2.6, z:44,   h:2.4, c:[224, 64,255]},   // 카메라 하우징
              {r:1.2, z:46.4, h:1.6, c:[255,190,255]},   // 발광 렌즈
              {r:0.6, z:48,   h:4.6, c:[224, 64,255]} ]},// 위로 솟는 표식
    ...
    { id:"m-hyd", label:"소화전", source:"hyd",
      parts:[ {r:4.2, z:0,    h:1.2, c:[150, 22, 18]},   // 베이스 플랜지(어두운 적)
              {r:2.5, z:1.2,  h:6.3, c:[198, 30, 24]},   // 하부 배럴
              {r:3.1, z:7.5,  h:0.8, c:[150, 22, 18]},   // 볼트 플랜지
              {r:3.5, z:8.3,  h:3.4, c:[226, 40, 32]},   // 노즐부 몸통(가장 굵은 단)
              {r:3.9, z:11.7, h:0.9, c:[150, 22, 18]},   // 어깨 링
              {r:3.0, z:12.6, h:1.6, c:[226, 40, 32]},   // 보닛 하단
              {r:2.1, z:14.2, h:1.2, c:[240, 60, 50]},   // 보닛 상단(테이퍼)
              {r:1.2, z:15.4, h:0.9, c:[198, 30, 24]},   // 목
              {r:0.6, z:16.3, h:0.5, c:[255,120,105]} ]},// 오각 캡
