...
RULES: list[tuple[str, str, str]] = [
    ...
    # ★ 2026-09-17 (DECISIONS §183-2). 도로명주소 건물DB(`202607_건물db_전체분.zip`) 규칙을 내렸다.
    #   retired 로 보관했다 — 내비게이션용DB(navi_build)가 같은 행을 좌표까지 든다. 대장이 정본이고 규칙이 따른다.
    #   다시 받으면 규칙 밖 파일로 멈춘다(반입하지 않는다).
