...
from seg.params import (  # noqa: E402
...
def main():
    ...
    corr, use = seg_graph.access_corridor(G, ent, poly)
    ...
    _bnx = BasisNumberIndex.from_gdf(road)
    if _bnx.unmerged:
    ...
    if ngii1k_u is not None:
        from guards import GuardFailure, coverage_check
        try:
