...
EXCEPTIONS: dict[str, int] = {
    # 시험 (상한 700)
    # ★ 2026-09-26 (§258-11). 2430 → 2462. SKIP 사유 강제의 세 방향(선언된 SKIP 통과 ·
    #   사유 없는 SKIP 차단 · 판정 입력 밖은 안 본다)과 그 사유다. 종전 한 시험이
    #   **결함을 고정하고** 있었으므로 지우는 대신 세 개로 갈랐다.
    "tests/test_guards.py": 2462,
